...
4.  **Install Arabic Fonts (Optional but Recommended)**
    For proper Arabic subtitle rendering and to avoid missing characters/rectangles:
    -   Run `install_fonts.bat` to automatically install Lyon Arabic Display fonts.
    -   This ensures Arabic text displays correctly in subtitles.
