...
def render_specific_video(json_full_path):
    ...
    try:
        ...
        lang = config.pop('lang', 'ar')  # extract so it isn't passed via **config
        ...
        # 1. Generate ASS
        adjust.generate_ass_from_file(json_full_path, ass_path, project_folder, **config, face_modes=face_modes, lang=lang)
