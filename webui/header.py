...
<div style="background: rgba(255, 165, 0, 0.1); padding: 10px; border-radius: 5px; margin-bottom: 20px; border-left: 3px solid orange;">
<p style="margin: 0; font-size: 0.9em;">
<strong>💡 Tip:</strong> For proper Arabic subtitle rendering, run <code>install_fonts.bat</code> once to install Lyon Arabic Display fonts.
</p>
</div>
